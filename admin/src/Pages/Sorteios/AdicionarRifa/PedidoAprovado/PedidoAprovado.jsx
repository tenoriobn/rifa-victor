...
export default function PedidoAprovado() {
  ...
  return (
    <div className="category full-width">
      <h3>TEXTO PEDIDO APROVADO</h3>

      <Editor
        name="description_order_approve"
        ...
        initialValue={formState.description_order_approve} // Use o valor do estado atual como valor inicial
