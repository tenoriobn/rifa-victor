  ...
  return (
    <div className="category">
      ...
      <label htmlFor="">
          ...
          <input className="qtd_max" name="max_amount" id="max_amount" maxLength="6" minLength="1" value="1.000" />
      </label>

      <label htmlFor="">
          Qtd cotas máxima por cliente
          <input className="qtd" name="max_amount_person" maxLength="10"  minLength="1" value="20.000" />
      </label>
    </div>
  )
}
