...
class StoreRifasRequest extends FormRequest
{
    ...
    public function rules(): array {
        return [
            ...
            "qntd_cota" => ["required", "bail", "min:0"],
            "qntd_cota_min_order" => ["required", "bail", "min:0"],
            "qntd_cota_max_order" => ["required", "bail", "min:0"],
            "qntd_cota_max_client" => ["required", "bail", "min:0"],
            "time_pay" => ["required", "bail", "min:0"],
