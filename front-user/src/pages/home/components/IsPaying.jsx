...
export default function IsPaying(props) {
  ...
  return (
    <div
      ...
      } fixed top-0 bottom-0 left-0 right-0 z-50  bg-[rgba(0,0,0,.7)] overflow-auto flex-col items-center justify-center p-4`}
    >
          ...
          <form>
           ...
           {paymentHash && (
            ...
            <div className="bg-blue-200 p-2 mt-3 rounded-md">
              ...
              <p className="font-bold text-blue-700 uppercase mb-1">Nome do sorteio</p>
              <p className="font-bold text-blue-700 mb-1">Nome: <span className="uppercase">Bernardo Costa</span></p>
              <p className="font-bold text-blue-700 mb-1">Telefone: <span className="uppercase">(21) 99999-9999</span></p>
              <p className="font-bold text-blue-700 mb-1">Valor total: <span className="uppercase">R$ 45,00</span></p>
            </div>
          </form>
        </article>
      </article>
