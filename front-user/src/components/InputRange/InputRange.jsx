...
import { estadoValorRange } from "../../common/state/atom";
  ...
  return (
    <>
      <p className='font-semibold'>
        Quantidade 
        <span className='text-xs'> (Qtd. minima: 35)</span>
      </p>
      ...
      <div className="flex justify-between text-xs gap-2 items-center mb-4">
        ...
        <div className="relative w-full flex items-center h-5">
          ...
          <span className="absolute pointer-events-none peer-disabled:bg-opacity-50 rounded-s-lg bg-amber-500 dark:bg-amber-500 h-3" style={{width: `${calcularPorcentagem(valorRange)}%`}}></span>
        </div>
