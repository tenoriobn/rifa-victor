    ...
    <div className="mt-4">
      <div className="w-full flex flex-col">
        <button 
          ...
          className='text-white font-medium rounded-md text-sm px-2.5 py-1.5 bg-green-500 hover:bg-green-600 outline-none inline-flex mb-1.5 w-full duration-300'
        >
        ...
        <div 
          className={`text-sm text-gray-500 dark:text-gray-500 bg-gray-100 rounded-lg overflow-hidden transition-max-height duration-200 px-2 ${selecaoAtiva === 'descricaoProduto' ? 'max-h-96 pt-1.5 pb-3 mt-1.5 mb-3' : 'max-h-0'}`}
        >
      ...
      <div className={`w-full flex-col ${display}`}>
        ...
        <div 
          className={`text-sm text-gray-500 dark:text-gray-500 bg-gray-100 rounded-lg overflow-hidden transition-max-height duration-200 ease-in-out px-2 ${selecaoAtiva === 'descricaoSorteio' ? 'max-h-96 pt-1.5 pb-3 mt-1.5 mb-3' : 'max-h-0'}`}
        >
