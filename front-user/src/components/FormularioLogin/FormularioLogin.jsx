...
export default function FormularioLogin() {
  ...
  return (
    <motion.form className="w-full" onSubmit={handleLogin} {...animacao}>
      <div className='bg-gray-100 border border-solid border-white/50 rounded-lg p-4 text-xl max-w-[420px] mx-auto mb-6'>
        <div className='flex flex-col mt-2'>
          ...
          <div className="relative">
            ...
            <input 
              ...
              className='block w-full pl-10 rounded-md text-sm text-gray-900 ring-gray-300 ring-1 ring-inset outline-none px-3.5 py-2.5 focus:ring-2 focus:ring-green-500 transition ease-in-out'
              maxLength={15}
      ...
      <button 
        type="submit" 
        className="text-sm font-medium rounded-md shadow-sm text-white  bg-green-500 w-full hover:bg-green-600 max-w-[420px] flex justify-center items-center px-3.5 py-2.5 mx-auto transition duration-300"
      >
        Efetuar Login
      </button>
    </motion.form>
